...
-   the exec() system call run different program(e.g. call *wc* command
    in exec())
...
![](clipboard-20260615T173537.png) ***timeline for trap table set up***
...
> about the length of echo job. So we need a approach without *priority*
