...
In this case, the request need the memory which more than 10 bytes, it's will fail to allocate and return NULL; there isn't singal contigous chunk of memory of that size availabel
