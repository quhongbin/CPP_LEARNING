...
1. internal fragmentaion
    As it allocate a fixed-sized contiguous physical memory for entire process(include codes, heap, stack so forth), the spaces bettwen head and stack is internal fragmentaion;

[[file:images/dynamic-relocation.png][dynamic relocation internal fragmentation]]
...
[[file:images/segmentation.png][segmentation shows]]
...
[[file:images/allocate-by-segmentation.png][translate address by segmentation]]

How to select segment we referring to correctly?
...
[[file:images/approch_to_segmentation.png][approach to select segment]]
...
* TODO example for how to allocate memory stack
+ to explain stack memory how to allocate
