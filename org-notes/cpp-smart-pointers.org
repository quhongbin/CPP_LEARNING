...
#+hugo_tags: "Pointer" "Memory Management"
#+hugo_categories: "CPP"
...
Godot engine uses its own smart pointer template ~Ref<T>~ instead of ~std::shared_ptr<T>~. It works exclusively with classes that inherit from ~RefCounted~, which embeds the reference counter directly inside the object (intrusive reference counting — see [[id:20250527T064553][Reference Counting]]).
...
- [[id:20250527T064553][Reference Counting]] — the mechanism shared_ptr and Ref<T> use to track ownership
- [[id:20250527T190202][C++ Templates]] — all smart pointers are class templates
- [[id:20250527T012125][Copy Constructors]] — smart pointers implement copy and move semantics
- [[id:20250527T012935][C++ Memory Management]] — parent topic; RAII and resource lifetime
- [[id:20250527T010446][C++ Function Pointers]] — custom deleters can be function pointers or lambdas
- [[id:20250527T061305][C++ void* Pointers]] — raw void* is the pre-modern way to handle type-erased pointers; smart pointers replace it
