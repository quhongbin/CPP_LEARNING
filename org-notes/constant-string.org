...
# const and constexpr
:PROPERTIES:
:ROAM_ALIASES: const constexpr
:ID:       91a920ec-9bec-4391-9b32-0e857533781a
:END:
1. on variable value
...
:PROPERTIES:
:ROAM_ALIASES: string string_view
:ID:       d637ba3b-8b53-4e94-8aac-7ae9879f986b
:END:
...
:PROPERTIES:
:ROAM_ALIASES: constant-folding
:ID:       b13943f1-a2ac-4a4b-ac71-4f1feb1afa48
:END:
as-if rule
