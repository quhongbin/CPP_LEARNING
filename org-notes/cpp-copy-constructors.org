...
#+hugo_tags: "Memory Management" "RAII"
#+hugo_categories: "CPP"
...
Follow the Rule of Zero by default. Prefer ~std::string~, ~std::vector~, smart pointers ([[id:20250527T230614][C++ Smart Pointers & Ref]]), and other RAII types over raw pointers. These types handle copy and move semantics correctly — you inherit correct behavior without writing a single special member function.
...
- [[id:20250527T230614][C++ Smart Pointers & Ref]] — smart pointers implement correct copy/move semantics (unique_ptr is move-only)
- [[id:20250527T064553][Reference Counting]] — shared_ptr's copy constructor increments the reference count
- [[id:20250527T012935][C++ Memory Management]] — parent topic; RAII binds resource lifetime to object lifetime
- [[id:20250527T190202][C++ Templates]] — template constructors are never copy constructors; template classes follow the same rules
- [[id:20250527T033930][C++ Enum vs Struct Class]] — structs with raw pointers need custom copy constructors (Rule of Three)
- [[id:20250527T010446][C++ Function Pointers]] — lambdas with copy captures invoke copy constructors of captured objects
