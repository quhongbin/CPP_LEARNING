...
Alignment matters for performance (cache-line alignment avoids false sharing in multi-threaded code) and for correctness when doing low-level memory work (casting ~void*~ to typed pointers — see [[id:20250527T061305][C++ void* Pointers]]).
...
Smart pointers ([[id:20250527T230614][C++ Smart Pointers & Ref]]) are the canonical RAII wrapper for heap memory: the pointer is the resource, the constructor takes ownership, the destructor calls ~delete~.
...
- [[id:20250527T230614][C++ Smart Pointers & Ref]] — automatic memory management through RAII; unique_ptr, shared_ptr, weak_ptr, and Godot's Ref<T>
- [[id:20250527T064553][Reference Counting]] — shared ownership tracking; atomic vs non-atomic; intrusive vs non-intrusive
- [[id:20250527T061305][C++ void* Pointers]] — raw untyped memory access; the foundation of ~malloc~/~free~ and custom allocators
- [[id:20250527T012125][Copy Constructors]] — controlling how objects are copied; deep vs shallow copy; move semantics

** Related Language Features

- [[id:20250527T190202][C++ Templates]] — custom allocators are templated on the type they allocate
- [[id:20250527T010446][C++ Function Pointers]] — factory functions and custom deleters use function pointers
- [[id:20250527T033930][C++ Enum vs Struct Class]] — struct layout and alignment relate to memory layout and padding
