...
#+date: <2025-05-27 Tue>
:PROPERTIES:
:ID:       608ddcb6-9345-4cee-9aae-9dc1c2783338
:END:
...
** Basic Syntax
:PROPERTIES:
:ROAM_ALIASES: function-template
:ID:       87686986-b6d3-4b26-80cb-991ed0951b47
:END:
...
** Templates in Godot
:PROPERTIES:
:ROAM_ALIASES: alloc_static bool
:ID:       d49345ac-6b03-4217-ae9e-0c6f8843c952
:END:
...
Another critical Godot template is ~Ref<T>~ ([[id:1d07decd-4659-494a-835e-defca639a771][C++ Smart Pointers & Ref]]), which is a reference-counted smart pointer template. It only accepts classes derived from ~RefCounted~, enforced through template constraints.

** Template Specialization — Full and Partial
:PROPERTIES:
:ROAM_ALIASES: full-specialization partial-specialization
:ID:       0bb3219c-ed4d-4b26-92ca-81c63896f542
:END:
...
:PROPERTIES:
:ROAM_ALIASES: SFINAE enable_if
:ID:       5d6a4dab-601f-4574-a34c-aabd3ea525ec
:END:
...
:PROPERTIES:
:ROAM_ALIASES: variadic-template parameter-pack
:ID:       a09e1fe2-b087-41fb-a5c9-f11a867f29d0
:END:
...
** C++20 Concepts
:PROPERTIES:
:ROAM_ALIASES: concept requires
:ID:       dcf0767d-b882-4212-bf71-26fca4a2370b
:END:
...
** Key Point
:PROPERTIES:
:ROAM_ALIASES: compile-time
:ID:       41cb2e93-79f5-445a-8cb1-65f3320d9d3a
:END:
...
- [[id:1d07decd-4659-494a-835e-defca639a771][C++ Smart Pointers & Ref]] — Ref<T>, unique_ptr<T>, shared_ptr<T> are all class templates
- [[id:dae30869-f9e6-43e5-b188-661d59b714c4][C++ void* Pointers]] — compile-time type erasure (templates) vs runtime type erasure (void*)
- [[id:470066fc-cee3-48da-a217-9abc41c4818d][C++ Function Pointers]] — std::function is a class template; function pointer types can be template parameters
- [[id:2ae84663-9f28-426d-a4eb-a8ffebae71b2][C++ Enum vs Struct Class]] — enums and structs work as template type parameters and non-type template arguments
- [[id:d90d89de-f807-4187-a9f7-a1501e9dcda5][C++ Memory Management]] — custom allocators are templated on the type they allocate
- [[id:f5899ea2-320f-4845-8ed3-68b68ba1cdcd][Copy Constructors]] — templates interact with copy semantics; template constructors are never copy constructors
