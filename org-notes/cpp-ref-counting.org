...
- [[id:20250527T230614][C++ Smart Pointers & Ref]] — shared_ptr and Ref<T> use reference counting
- [[id:20250527T012125][Copy Constructors]] — copy constructors trigger reference count increments
- [[id:20250527T012935][C++ Memory Management]] — parent topic; reference counting vs other GC strategies
- [[id:20250527T190202][C++ Templates]] — shared_ptr's control block is a template implementation detail
