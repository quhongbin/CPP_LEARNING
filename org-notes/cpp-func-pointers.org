...
#+date: <2025-05-27 Tue>
:PROPERTIES:
:ID:       470066fc-cee3-48da-a217-9abc41c4818d
:END:
...
** Basic Syntax
:PROPERTIES:
:ROAM_ALIASES: function-pointer
:ID:       1a890324-07fb-46ea-86b9-7e9be0ce635c
:END:
...
** Using Typedef
:PROPERTIES:
:ROAM_ALIASES: typedef-alias
:ID:       f54b8122-131b-43b6-8bea-e27eb9d04b79
:END:
...
:PROPERTIES:
:ROAM_ALIASES: factory-pattern
:ID:       0da92c77-aa2b-4cce-ac29-28d47e0815e4
:END:
...
:PROPERTIES:
:ROAM_ALIASES: std::function type-erasure
:ID:       c8392b26-c30f-4919-937a-0308bc07969e
:END:
...
:PROPERTIES:
:ROAM_ALIASES: lambda closure
:ID:       0676e8e8-b3e7-4c17-b0b7-44717d4160c9
:END:
...
:PROPERTIES:
:ROAM_ALIASES: member-function-pointer pointer-to-member
:ID:       c494f9c7-ffc8-488f-aa1a-fea4ef50f5e6
:END:
...
:PROPERTIES:
:ROAM_ALIASES: performance devirtualization
:ID:       c317f4bb-7b64-4880-b295-e60697510065
:END:
...
** Calling Conventions
:PROPERTIES:
:ROAM_ALIASES: calling-convention ABI
:ID:       94ba0b8f-15cf-4303-8209-b33e13c814ca
:END:
...
- [[id:1d07decd-4659-494a-835e-defca639a771][C++ Smart Pointers & Ref]] — custom deleters can be function pointers; factory functions return smart pointers
- [[id:608ddcb6-9345-4cee-9aae-9dc1c2783338][C++ Templates]] — templates subsume many function-pointer use cases (std::function is a template)
- [[id:dae30869-f9e6-43e5-b188-661d59b714c4][C++ void* Pointers]] — function pointers and data pointers (void*) are distinct types
- [[id:d90d89de-f807-4187-a9f7-a1501e9dcda5][C++ Memory Management]] — factory functions with function pointers manage ownership
- [[id:f5899ea2-320f-4845-8ed3-68b68ba1cdcd][Copy Constructors]] — lambdas with copy captures invoke copy constructors
- [[id:2ae84663-9f28-426d-a4eb-a8ffebae71b2][C++ Enum vs Struct Class]] — enums as non-type template parameters can select function-pointer specializations
