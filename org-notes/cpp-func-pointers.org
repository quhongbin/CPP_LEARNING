...
- [[id:20250527T230614][C++ Smart Pointers & Ref]] — custom deleters can be function pointers; factory functions return smart pointers
- [[id:20250527T190202][C++ Templates]] — templates subsume many function-pointer use cases (std::function is a template)
- [[id:20250527T061305][C++ void* Pointers]] — function pointers and data pointers (void*) are distinct types
- [[id:20250527T012935][C++ Memory Management]] — factory functions with function pointers manage ownership
- [[id:20250527T012125][Copy Constructors]] — lambdas with copy captures invoke copy constructors
- [[id:20250527T033930][C++ Enum vs Struct Class]] — enums as non-type template parameters can select function-pointer specializations
