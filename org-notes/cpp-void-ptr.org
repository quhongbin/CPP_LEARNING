...
#+date: <2025-05-27 Tue>
:PROPERTIES:
:ID:       dae30869-f9e6-43e5-b188-661d59b714c4
:END:
...
** Key Properties
:PROPERTIES:
:ROAM_ALIASES: type-erasure
:ID:       ca0568ea-af98-4f20-be83-01f9e46f71cf
:END:
...
** Example
:PROPERTIES:
:ROAM_ALIASES: void-cast
:ID:       f238b4fb-580f-4c13-9870-0f856d621371
:END:
...
:PROPERTIES:
:ROAM_ALIASES: type-erasure pimpl
:ID:       dc8a36af-fd0d-4ff1-9f09-b5bf9e9a80c7
:END:
...
However, ~void*~-based type erasure has a critical weakness compared to templates: it moves type checking from compile time to runtime. If you cast to the wrong type, you get undefined behavior with no compiler warning. Templates ([[id:608ddcb6-9345-4cee-9aae-9dc1c2783338][C++ Templates]]) provide compile-time type erasure with full safety — the tradeoff is potential code bloat from multiple instantiations.

** std::any — The Modern Alternative
:PROPERTIES:
:ROAM_ALIASES: std::any any_cast
:ID:       071dbb7c-61e0-4dfb-a730-f5c144a70214
:END:
...
:PROPERTIES:
:ROAM_ALIASES: C-ABI FFI
:ID:       ce34497f-f0c8-40ad-8a0d-deb347cc06e5
:END:
...
** reinterpret_cast and Alignment Pitfalls
:PROPERTIES:
:ROAM_ALIASES: reinterpret_cast strict-aliasing
:ID:       46f4b916-403c-4599-b9d1-7a4d700ae6ec
:END:
...
:ID:       65a0df58-af23-4fb7-b080-869f7d22caf7
:END:
...
- Writing custom allocators ([[id:d90d89de-f807-4187-a9f7-a1501e9dcda5][C++ Memory Management]])
...
- Templates — compile-time type erasure with zero runtime overhead ([[id:608ddcb6-9345-4cee-9aae-9dc1c2783338][C++ Templates]])
- Smart pointers — typed ownership with automatic cleanup ([[id:1d07decd-4659-494a-835e-defca639a771][C++ Smart Pointers & Ref]])

** Related Notes

- [[id:608ddcb6-9345-4cee-9aae-9dc1c2783338][C++ Templates]] — compile-time type erasure vs void* runtime type erasure
- [[id:d90d89de-f807-4187-a9f7-a1501e9dcda5][C++ Memory Management]] — void* is the return type of malloc/calloc, central to allocator design
- [[id:1d07decd-4659-494a-835e-defca639a771][C++ Smart Pointers & Ref]] — smart pointers eliminate the need for void* in ownership scenarios
- [[id:470066fc-cee3-48da-a217-9abc41c4818d][C++ Function Pointers]] — function pointers cannot reliably be stored in void*; use std::function
