...
- Writing custom allocators ([[id:20250527T012935][C++ Memory Management]])
...
- Templates — compile-time type erasure with zero runtime overhead ([[id:20250527T190202][C++ Templates]])
- Smart pointers — typed ownership with automatic cleanup ([[id:20250527T230614][C++ Smart Pointers & Ref]])

** Related Notes

- [[id:20250527T190202][C++ Templates]] — compile-time type erasure vs void* runtime type erasure
- [[id:20250527T012935][C++ Memory Management]] — void* is the return type of malloc/calloc, central to allocator design
- [[id:20250527T230614][C++ Smart Pointers & Ref]] — smart pointers eliminate the need for void* in ownership scenarios
- [[id:20250527T010446][C++ Function Pointers]] — function pointers cannot reliably be stored in void*; use std::function
